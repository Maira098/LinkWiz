...
/* ─────────────── COMPONENT ─────────────── */
export default function LinkWizPublicProfile() {
      ...
      <section style={{ paddingTop: "140px", paddingBottom: "100px", minHeight: "100vh" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 40px" }}>
          ...
          <div style={{ background: "rgba(255,255,255,.02)", border: "1px solid rgba(255,255,255,.06)", borderRadius: 24, padding: "50px", position: "relative", overflow: "hidden", marginBottom: 40, textAlign: "center" }}>
            ...
            <div style={{ width: 120, height: 120, borderRadius: "50%", background: "linear-gradient(135deg,#8b5cf6,#a78bfa)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 40, fontWeight: 900, color: "#fff", margin: "0 auto 20px", border: "4px solid #04060e", boxShadow: "0 0 0 1px rgba(255,255,255,.1)" }}>AR</div>
            
            <h1 style={{ fontFamily: "Fraunces,Georgia,serif", fontSize: 36, fontWeight: 900, color: "#e8edff", marginBottom: 8 }}>Ahmed Raza</h1>
            <div style={{ display: "flex", justifyContent: "center", gap: 16, color: "#8892a4", fontSize: 14, marginBottom: 24 }}>
              <span style={{ display: "flex", alignItems: "center", gap: 4 }}><Icons.MapPin /> Lahore, Pakistan</span>
            ...
            <p style={{ fontSize: 15, color: "#c4d0e8", lineHeight: 1.7, maxWidth: 600, margin: "0 auto 30px" }}>
              Marketing executive turned design enthusiast. I have extensive experience in digital marketing, SEO, and content strategy. Looking to dive deep into UX/UI design and frontend development. Let's build something awesome together.
            </p>

            <PrimaryBtn style={{ padding: "15px 32px", fontSize: 15 }} onClick={() => alert("Exchange request sent!")} onMouseEnter={big} onMouseLeave={small}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, marginBottom: 40 }}>
            <HoverCard onMouseEnter={big} onMouseLeave={small} style={{ padding: "32px 26px" }}>
              <h3 style={{ fontSize: 12, fontWeight: 700, color: "#93c5fd", letterSpacing: ".1em", textTransform: "uppercase", marginBottom: 20, display: "flex", alignItems: "center", gap: 8 }}><Icons.Sparkle /> Ahmed Offers</h3>
              <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
                {["Digital Marketing", "SEO", "Copywriting", "Social Media"].map(s => (
                  <span key={s} style={{...S.cBlue, fontSize: 14, padding: "8px 16px"}}>{s}</span>
                ))}
              </div>
            </HoverCard>
            
            <HoverCard onMouseEnter={big} onMouseLeave={small} style={{ padding: "32px 26px" }}>
              <h3 style={{ fontSize: 12, fontWeight: 700, color: "#6ee7b7", letterSpacing: ".1em", textTransform: "uppercase", marginBottom: 20, display: "flex", alignItems: "center", gap: 8 }}><Icons.Search /> Ahmed Wants</h3>
              <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
                {["UX Design", "Figma", "React", "Web Dev"].map(s => (
                  <span key={s} style={{...S.cGreen, fontSize: 14, padding: "8px 16px"}}>{s}</span>
                ))}
              </div>
            </HoverCard>
          </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
              {TESTIMONIALS.slice(0,2).map((t, i) => (
                <div key={i} style={{ background: "rgba(255,255,255,.015)", border: "1px solid rgba(255,255,255,.05)", borderRadius: 16, padding: "24px" }}>
                  ...
                  <p style={{ color: "#8892a4", fontSize: 14, lineHeight: 1.7, marginBottom: 16, fontStyle: "italic" }}>"Ahmed is a fantastic mentor for marketing. Very clear and patient!"</p>
